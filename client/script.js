...
socket.on("connect", function() {
    ...
    var div_contenedorChat = document.getElementById("contenedorChat");
    ...
    socket.on("sala-creada", function() {
        ...
        .then(function(stream) {
            ...
            div_contenedorChat.style = "display: block"
    ...
    button_enviar.addEventListener("click", function () {
        div_mensajeEnviado.innerHTML+="<p><strong>" + input_usuario.value + ": </strong>" + input_mensaje.value + "</p>";
