...
io.on("connection", function(socket) {
    ...
    socket.on("enviar-mensaje", function(datos, nombreSala) {
        socket.broadcast.to(nombreSala).emit("recibir-mensaje", datos); //Se le envía el mensaje a todos los demás, menos al que lo envió.
    });
